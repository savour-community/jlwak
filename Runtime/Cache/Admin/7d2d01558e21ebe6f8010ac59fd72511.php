...
<table>
  <tr>
    <td>
    <form action="/index.php/Admin/News/upd_news/id/8" method="post" enctype="multipart/form-data">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
     <tr>
      ...
      <tr>
        ...
        <td  bgcolor="#FFFFFF" class="STYLE19"><div align="left">
            <input type="text" name="excerpt" value="<?php echo ($info["excerpt"]); ?>"/>
        </div></td>
      </tr>
       ...
       <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
           <div align="left">
               ...
               <img src='<?php echo (SET_URL); echo (substr($info["news_b_tx "],2)); ?>'alt='图片' width="80" height="80" />
           </div>
        </td>
      </tr>
