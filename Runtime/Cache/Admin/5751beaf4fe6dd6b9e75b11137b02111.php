...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
    <form action="/index.php/Admin/Develop/upd_develop/id/2" method="post">
     <input type="hidden" name='id' value='<?php echo ($info["id"]); ?>' />
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
     <tr>
        <td bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">阶段时间：</span></div></td>
        <td  bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="period" value="<?php echo ($info["period"]); ?>"/>
        </div></td>
      </tr>
        <tr>
            <td bgcolor="#FFFFFF" class="STYLE6"><div align="right"><span class="STYLE19">阶段内容：</span></div></td>
            <td  bgcolor="#FFFFFF" class="STYLE19"><div align="left">
