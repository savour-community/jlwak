...
<table>
    <tr>
        <td>
            <form action="/index.php/Admin/Costomer/insert_record" method="post" enctype="multipart/form-data">
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                    <tr class="hire_box">
                    <td class="hire_left">客户名字：</td>
                    <td class="hire-right"><input type="text" name="name" /></td>
                </tr>
                <tr>
