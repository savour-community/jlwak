...
<table>
    <tr>
        <td>
            <form action="/index.php/Admin/Develop/insert_record" method="post" enctype="multipart/form-data">
                <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
                 <tr class="hire_box">
                    <td class="hire_left">阶段时间：</td>
                    <td class="hire-right"><input type="text" name="period" /></td>
                </tr>
                <tr class="hire_box">
                    <td class="hire_left">阶段内容：</td>
                    <td class="hire-right"><input type="text" name="detail" /></td>
                </tr>
                <tr>
