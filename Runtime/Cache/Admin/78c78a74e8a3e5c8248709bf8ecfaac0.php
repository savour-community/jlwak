...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td>
    <form action="/index.php/Admin/Product/upd/id/2" method="post">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
     <tr>
      ...
      <tr>
        ...
        <td  bgcolor="#FFFFFF" class="STYLE19"><div align="left">
        <input type="text" name="product_profile" value="<?php echo ($info["product_profile"]); ?>"/>
        </div></td>
      </tr>
       ...
       <tr>
        ...
        <td height="20" bgcolor="#FFFFFF" class="STYLE19">
           <div align="left"><input type="file" name="product_b_tx" /><img src='<?php echo (SET_URL); echo (substr($info["product_b_tx "],2)); ?>'alt='图片' width="80" height="80" /></div>
        </td>
      </tr>
...
<script type="text/javascript">
   var ue = UE.getEditor('news_content',{toolbars: [[
