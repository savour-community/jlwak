...
<div class="son_banner" style="background-color:white;">
    <img width="100%" height="500px" src="<?php echo (IMG_HOME_URL); ?>banner1.jpg">
</div>
<div style="width:100%; background-color:white; margin-top:-15px">
    <div class="cpfw" >
        ...
        <div class="top">
            <div class="dqwz">
                <a href="/">首页</a>&nbsp;&gt;&gt;&nbsp;<a href="#">产品服务</a>
            </div>
        </div>
        <div class="middle">
            <ul>
               <?php if(is_array($product)): foreach($product as $k=>$v): ?><li class="wzjs">
                    <div class="l_logo">
                        <img width="300" height="256" src="<?php echo (SET_URL); echo (substr($v["product_b_tx"],2)); ?>" alt="">
                    </div>
                    <div class="r_content">
                        <div class="hd">
